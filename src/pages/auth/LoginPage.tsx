    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-between gradient-hero p-12 text-white relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-1/4 -left-20 h-80 w-80 rounded-full bg-accent-400/10 blur-3xl" />
        </div>
        ...
        <div className="relative">
          ...
          <p className="max-w-md text-lg text-white/70">
            Plan multi-city trips, track budgets, and get AI-powered recommendations — all in one place.
          </p>
        </div>
        ...
        <div className="w-full max-w-md space-y-8 animate-slide-up">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-surface-50 px-3 text-surface-400">Or continue with email</span>
            </div>
          </div>
