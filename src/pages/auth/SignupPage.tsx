...
export function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-between gradient-hero p-12 text-white relative overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/3 -right-20 h-80 w-80 rounded-full bg-white/5 blur-3xl" />
          <div className="absolute bottom-1/3 -left-20 h-80 w-80 rounded-full bg-accent-400/10 blur-3xl" />
        </div>
        ...
        <div className="relative">
          ...
          <p className="max-w-md text-lg text-white/70">
            Create your free account and unlock AI-powered travel planning, smart budgeting, and more.
          </p>
        </div>
        <div className="relative text-sm text-white/50">
          © 2026 GlobeTrotter AI
        </div>
      </div>
      ...
      <div className="flex w-full items-center justify-center px-4 py-12 lg:w-1/2">
        <div className="w-full max-w-md space-y-8 animate-slide-up">
          ...
          <Button variant="outline" className="w-full gap-3 h-11" onClick={handleGoogleSignUp}>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-surface-50 px-3 text-surface-400">Or sign up with email</span>
            </div>
          </div>
